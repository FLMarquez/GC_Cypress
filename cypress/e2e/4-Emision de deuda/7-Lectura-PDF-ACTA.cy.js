...
describe('Test de extracción de texto de PDF', () => {
    it('Extrae texto de un archivo PDF y valida', () => {
        ...
        //RUTA LOCAL
        const pdfFilePath = 'C:\\home\\workspace\\GODOYCRUZ\\aadeudacontadosellados2_impl(1).pdf';
        //RUTA SERVER - ELINPAR
       ...
       expect(normalizedText).to.include('Infractor:');
       //expect(normalizedText).to.include(`${formattedDate}`);
       expect(normalizedText).to.include('Cuenta');
