...
describe('Test de extracción de texto de PDF', () => {
    it('Extrae texto de un archivo PDF y valida', () => {
        ...
        //RUTA LOCAL
        const pdfFilePath = 'C:\\home\\workspace\\GODOYCRUZ\\arptdeudacontribuyenteap_impl(1).pdf';
        //RUTA SERVER - ELINPAR
        ...
        .then((extractedText) => {
            ...
            expect(normalizedText).to.include('MULTA');
            expect(normalizedText).to.include('A110865/2');
            expect(normalizedText).to.include('Datos del Responsable');
            expect(normalizedText).to.include('Identificación Tributaria:');
            expect(normalizedText).to.include('20132594008');
            expect(normalizedText).to.include('Razón Social:');
            expect(normalizedText).to.include('VALDEZ JOSE');
            ...
            expect(normalizedText).to.include('Tasa');
