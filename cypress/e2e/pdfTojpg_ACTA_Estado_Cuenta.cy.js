describe('Convertir PDF a JPG', () => {
    it('Convierte un PDF ya descargado en imagen', () => {
        const pdfPath = 'C:/home/workspace/GODOYCRUZ/arptdeudacontribuyenteap_impl(1).pdf';
        ...
        cy.readFile('C:/home/workspace/GODOYCRUZ/arptdeudacontribuyenteap_impl(1)-1.jpg', { timeout: 10000 })
            .should('exist');
    });
});
