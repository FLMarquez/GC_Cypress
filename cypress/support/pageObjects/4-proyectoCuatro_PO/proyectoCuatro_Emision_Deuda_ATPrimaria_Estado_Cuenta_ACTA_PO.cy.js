...
class ProyectoCuatro_Emision_Deuda_ATPrimaria_Estado_Cuenta_ACTA_Po {
  ...
  SeccionDos(objeto, t) {
    ...
    cy.iframe().xpath("//a[contains(.,'Consultar')]").invoke('show').click({ force: true });
    cy.wait(5000);
...
export default ProyectoCuatro_Emision_Deuda_ATPrimaria_Estado_Cuenta_ACTA_Po;
