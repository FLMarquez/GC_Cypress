...
const commands = [
    `npx cypress run --browser firefox --spec "cypress/e2e/4-Emision de deuda/1-Atencion_Primaria_Emision_Deuda.cy.js" --reporter mocha-allure-reporter >> result.log 2>&1`,
    ...
    `npx cypress run --browser chrome --headed --spec "cypress/e2e/4-Emision de deuda/4-Verificar_Imagen.cy.js" --reporter mocha-allure-reporter >> result.log 2>&1`
];
