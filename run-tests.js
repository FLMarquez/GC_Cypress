...
const commands = [
    `npx cypress run --browser firefox --spec "cypress/e2e/4-Emision de deuda/1-Atencion_Primaria_Emision_Deuda.cy.js,cypress/e2e/4-Emision de deuda/6-Atencion_Primaria_Emision_Deuda_ACTA.cy.js,cypress/e2e/4-Emision de deuda/1.1-Atencion_Primaria_Emision_Deuda_Estado_Cuenta.cy.js,cypress/e2e/4-Emision de deuda/6.1-Atencion_Primaria_Emision_Deuda_Estado_Cuenta_ACTA.cy.js" --reporter mocha-allure-reporter >> result.log 2>&1`,

    `npx cypress run --browser chrome --headless --spec "cypress/e2e/1-Loguin/1-Login_GC_PO.cy.js,cypress/e2e/2-Personas/1-Personas_Valida_Pantalla.cy.js,cypress/e2e/2-Personas/2-Personas_Actualizacion_Datos.cy.js,cypress/e2e/2-Personas/3-Personas_Crear_Nuevo_Domicilio.cy.js,cypress/e2e/3-Objetos/1-Objetos_Validar_Pantalla.cy.js,cypress/e2e/3-Objetos/2-Objetos_Actividades_Comercio.cy.js,cypress/e2e/3-Objetos/3-Objetos_Consultar_Operacion_Catastro.cy.js,cypress/e2e/4-Emision de deuda/2-Lectura-PDF.cy.js,cypress/e2e/4-Emision de deuda/2.1-Lectura-PDF_Estado_Cuenta.cy.js,cypress/e2e/4-Emision de deuda/7-Lectura-PDF-ACTA.cy.js,cypress/e2e/4-Emision de deuda/7.1-Lectura-PDF-ACTA_Estado_Cuenta.cy.js,cypress/e2e/pdfTojpg.cy.js,cypress/e2e/pdfTojpg_ACTA.cy.js,cypress/e2e/pdfTojpg_Estado_Cuenta.cy.js,cypress/e2e/pdfTojpg_ACTA_Estado_Cuenta.cy.js,cypress/e2e/4-Emision de deuda/5-Consulta_de_Comprobantes.cy.js,cypress/e2e/5-Apremio/1-Apremio.cy.js,cypress/e2e/6-Juzgado_Faltas/1-Juzgado_Falta.cy.js,cypress/e2e/7-Emision_Tasas/1-Emision_Tasas.cy.js,cypress/e2e/8-Ingreso Full Web/1-Ingreso_Full_Web1_1.cy.js,cypress/e2e/8-Ingreso Full Web/1-Ingreso_Full_Web1_2.cy.js,cypress/e2e/8-Ingreso Full Web/1-Ingreso_Full_Web2.cy.js,cypress/e2e/8-Ingreso Full Web/1-Ingreso_Full_Web3_1.cy.js,cypress/e2e/8-Ingreso Full Web/1-Ingreso_Full_Web3_2.cy.js,cypress/e2e/8-Ingreso Full Web/1-Ingreso_Full_Web4.cy.js,cypress/e2e/8-Ingreso Full Web/1-Ingreso_Full_Web5.cy.js" --reporter mocha-allure-reporter >> result.log 2>&1`,

    `npx cypress run --browser chrome --headed --spec "cypress/e2e/4-Emision de deuda/4-Verificar_Imagen.cy.js,cypress/e2e/4-Emision de deuda/4.1-Verificar_Imagen_Estado_Cuenta.cy.js,cypress/e2e/4-Emision de deuda/8-Verificar_Imagen_ACTA.cy.js,cypress/e2e/4-Emision de deuda/8.1-Verificar_Imagen_ACTA_Estado_Cuenta.cy.js" --reporter mocha-allure-reporter >> result.log 2>&1`
];
