...
curl -X POST "https://api.telegram.org/bot7564088844:AAFexajTht_1DT6PW3rU2bcU7KJLWAmnt3o/sendDocument" ^
     -F "chat_id=2021931547" ^
     -F "document=@C:\Users\Lmarquez\Desktop\GodoyCuz_Cypress\allure-report\index.html"

rem Abrir el reporte localmente
